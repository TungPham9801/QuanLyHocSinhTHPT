...
namespace QuanLyHocSinhTHPT.GUI
{
    public partial class F_HocSinh : Form
    {
        ...
        #region Load
        private void F_HocSinh_Load(object sender, EventArgs e)
        {
        ...
        private void btnThemDanToc_Click_1(object sender, EventArgs e)
        {
            ThamSo.ShowFormDanToc();
            m_DanTocCtrl.HienThiDataGridViewComboBoxColumn(colMaDanToc);
        }

        private void btnThemTonGiao_Click_1(object sender, EventArgs e)
        {
            ThamSo.ShowFormTonGiao();
            m_TonGiaoCtrl.HienThiDataGridViewComboBoxColumn(colMaTonGiao);
        }

        private void btnThemNNCha_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnThemNNMe_Click_1(object sender, EventArgs e)
        {
